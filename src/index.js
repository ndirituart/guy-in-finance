...
const routes = [
  { 
    ...
    beforeEnter: (to, from, next) => {
      if (isAuthenticated()) {
        ...
        next('/login'); // Redirect to login if not authenticated (loggedin)
      }
    }
  },
  ...
  { path: '/SavingsPage', name: 'SavingsPage', component: SavingsPage, meta: { requiresAuth: true } },
  { path: '/Relations', name: 'Relations', component: Relations, meta: { requiresAuth: true } },
  { path: '/login', name: 'LoginPage', component: LoginPage },
    { path: '/register', name: 'RegisterPage', component: RegisterPage },
  {path: '/account', name: 'AccountPage', component: AccountsPage},
