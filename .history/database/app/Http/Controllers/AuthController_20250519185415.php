...
class AuthController extends Controller
{
    ...
    () {
        ...
        '); // Assuming you still have a Blade register
        //  form
    }
    ...
    (Request $request) {
        ...
        // You might want to log the user in automatically after register
    ...
    public function login(Request $request) {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return response()->json(['redirect' => '/home'], 200); // For API, you might return a token
        }
