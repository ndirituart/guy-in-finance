<!-- This is a placeholder for LoansApproval.vue, assuming a similar structure. -->
<!-- Ensure axios is imported at the top of your script section. -->
<template>
  <div class="loans-approval-page">
    <h1>Loan Approvals</h1>
    <!-- Your existing LoansApproval template content goes here -->
    <p>This is where admin can approve or deny loan requests.</p>
    <!-- Example: Displaying mock loan requests for approval -->
...
<script>
import axios from 'axios'; // <--- This line is crucial for LoansApproval.vue
