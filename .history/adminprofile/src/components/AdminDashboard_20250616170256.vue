...
<script>
import { createApp } from 'vue'; // Needed for simulating navigation
import LoanApprovals from './LoanApprovals.vue'; // Assume these exist at the specified paths
import UserAccounts from './UserAccounts.vue';
import OtpSupport from './OtpSupport.vue';
...
export default {
  ...
  methods: {
    ...
    loadMockData() {
      ...
      // This simulates a 'database' of all users for the admin view
    ...
    // --- Navigation Methods (simulated) ---
    // In a real Vue app, you would use Vue Router: this.$router.push('/admin/loan-approvals');

    navigateToLoanApprovals() {
      alert('Navigating to Loan Approvals...');
      document.body.innerHTML = '<div id="app"></div>';
      createApp(LoanApprovals).mount('#app');
    },
    navigateToUserAccounts() {
      alert('Navigating to User Accounts Management...');
      document.body.innerHTML = '<div id="app"></div>';
      createApp(UserAccounts).mount('#app');
    },
    navigateToOtpSupport() {
      alert('Navigating to OTP Support...');
      document.body.innerHTML = '<div id="app"></div>';
      createApp(OtpSupport).mount('#app');
    }
  }
};
</script>
