...
import HelloWorld from '@/components/HelloWorld.vue'; // Adjusted import path to match your structure
...
import AdminDashboard from '../userinterface/admin/AdminDashboard.vue';
...
const routes = [
  ...
  { path: '/admin', name: 'AdminHom', component: AdminDashboard },
