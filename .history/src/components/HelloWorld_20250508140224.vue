<template>
  <div>
    ...
    <!-- Logo Section -->
    <img alt="Vue logo" :src="require('@/assets/logo.png')" class="app-logo">

    <!-- Welcome Page Section -->
    <div class="welcome-page">
      <h2>What brings you here today?</h2>
      <button @click="proceed" :class="{ red: isClicked, orange: !isClicked }">PROCEED</button>
    </div>
  </div>
</template>
...
.app-logo {
  width: 150px; /* Customize size */
  height: 150px; /* Make logo circular if desired */
  margin-top: 20px;
}
...
button.orange {
  background-color: rgb(0, 255, 183); /* Orange when hovered before clicked */
}
