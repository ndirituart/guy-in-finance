...
import axios from 'axios'; // Import the axios library that connects to API endpoints to database
...
export default {
    ...
    setup() {
        ...
        const validationErrors = ref({}); // To store validation errors from the backend
        ...
        const submitForm = async () => { // Make the function async
        ...
        return {
            ...
            submitForm,
            goToLogin,
            validationErrors, // Return validation errors to display in the template
        };
    },
};
</script>
