...
.signup-login-btn {
  background-color: #28a745; /* A distinct green for sign-up */
  box-shadow: 0 4px 8px rgba(40, 167, 69, 0.2); /* Matching shadow for consistency */
  margin-top: 0.5rem; /* Space between text and button */
  display: inline-block; /* router-link renders as <a>, needs this for button styles */
