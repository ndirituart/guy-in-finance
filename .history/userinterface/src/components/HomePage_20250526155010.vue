  ...
  <div class="account-page">
    ...
    <div class="balance-container">
      <div class="balance-box">
        ...
        <p :class="{ 'blurred': isBlurred }">Ksh. {{ isBlurred ? '****' : balanceStore.accountBalance.toLocaleString() }}</p>
        <label>
...
<script>
import { useBalanceStore } from '../stores/balanceStore'; // Adjust path if your store file is elsewhere
...
export default {
  ...
  setup() {
    ...
    // Expose the store to the template (for Options API, return it from setup)
    return {
      balanceStore,
    };
  },
  data() {
    return {
      ...
      // accountBalance: 12390, // REMOVE THIS! It's now from the store
      loanBalance: 0.0, // Loan balance might come from another store or be local
      isBlurred: false
    };
  },
  methods: {
