...
import { useBalanceStore } from '@/stores/balanceStores.js';
// Future components
...
const routes = [
  ...
  //for the balance store to be accessed by all components (global state)
  // This route is not directly accessible but is used for state management
  {
    path: 'use-balance-store',
    name: 'useBalanceStore',
    component: () => import('@/components/BalanceStore.vue')
  }
  // Future routes
  // {
  //   path: '/budget',
